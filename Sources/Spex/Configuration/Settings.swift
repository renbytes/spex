...
struct Settings {
    ...
    init() {
        ...
        self.openaiApiUrl = Environment.get("OPENAI_API_URL") ?? "https://api.openai.com/v1/chat/completions"
        self.openaiDefaultModel = Environment.get("OPENAI_DEFAULT_MODEL") ?? "gpt-4o-mini"

        self.geminiApiKey = Environment.get("GEMINI_API_KEY")
        self.geminiApiUrl = Environment.get("GEMINI_API_URL") ?? "https://generativelanguage.googleapis.com/v1beta/models"
