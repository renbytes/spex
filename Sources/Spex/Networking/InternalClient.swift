...
final class InternalClient: LlmClient {
    ...
    func generateCode(prompt: String, model: String) async throws -> String {
        ...
        do {
            ...
            throw AppError.parsingError("Failed to encode internal request: \(error.localizedDescription)")
        }
        ...
        do {
            ...
            throw AppError.parsingError("Failed to decode response from gateway: \(error.localizedDescription)")
        }
    }
}
